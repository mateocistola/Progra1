...
def mostrarProfesionales():
    ...
    for profesional in profesionales:
        print("Matricula: " + profesional[0] + ", Nombre: " + profesional[1] + ", Especialidad: " + profesional[2] + ", Horario: " + str(profesional[3]) + " - " + str(profesional[4]))
    return

def menu():
    eleccion = 0
    eleccion = int(input("Ingrese 1 para agregar un profesional, 2 para quitar un profesional, 3 para modificar un profesional, 4 para modificar el horario de un profesional: "))
    match eleccion:
        case 1 :
...
def modificarHorario():
    ...
    for profesional in profesionales:
        if(profesional[0] == id):
            print("Horario actual: " + str(profesional[3]) + " - " + str(profesional[4]))
...
def editarProfesionales():
    ...
    for profesional in profesionales:
        if(profesional[0] == id):
            ...
            nombre = input("Ingrese nuevo nombre: o bien presione enter para mantener el nombre actual: ")
            if nombre == "":
                nombre = profesional[1]
            print("Especialidad actual: " + profesional[2])
            especialidad = input("Ingrese nueva especialidad: o bien presione enter para mantener la especialidad actual: ")
            if especialidad == "":
...
def agregarProfesionales():
    ...
    hInicio = input("Ingrese horario comienzo de atencion del del profesional: ")
    hFin = input("Ingrese horario fin de atencion del del profesional: ")
    profesionales.append([id, nombre, especialidad, hInicio, hFin])
    return
